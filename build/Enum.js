"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports.default=exports.createConstructor=void 0;var _utils=require("./utils");var _Type=require("./Type");// type TypeConstructor = ...a -> EnumTagType
// createConstructor :: (Enum, ConstructorDescription) -> TypeConstructor
var createConstructor=function createConstructor(Type,_ref){var name=_ref.name,props=_ref.props;return function(){for(var _len=arguments.length,args=new Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key]}if(props?!(0,_Type.validateArgs)(props,args):false)throw new TypeError("Invalid number of args passed to constructor ".concat(name));var self={// args :: Array *
