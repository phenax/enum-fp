...
exports.default = exports.createConstructor = void 0;

// type TypeConstructor = ...a -> EnumTagType
// validateArguments :: (?Array String, [a]) -> Boolean
var validateArguments = function validateArguments(props, args) {
...
var createConstructor = function createConstructor(name, Type, props) {
  return function () {
    ...
    if (!validateArguments(props, args)) throw new TypeError("Invalid number of arguments passed to constructor ".concat(name));
    var self = {
      // args :: Array *
      args: args,
      // name :: String
...
var _default = createConstructor;
